...
<nav class="navbar">
        <ul class="navbar-nav">
            <li class="logo"> <!-- Logo -->
                <a href="<?php echo "//localhost/itisdev/StockController/invcontrollerhome.php"; ?>" class="nav-link">
            ...
            <li class="nav-item"> <!-- Input Stock Purchased -->
                <a href="<?php echo "//localhost/itisdev/StockController/stockpurchased.php"; ?>" class="nav-link">
            ...
            <li class="nav-item"> <!-- Input Manual Stock Count -->
                <a href="<?php echo "//localhost/itisdev/StockController/manstockcount.php"; ?>" class="nav-link">
            ...
            <li class="nav-item"> <!-- View Stock -->
                <a href="//localhost/itisdev/StockController/viewstock.php" class="nav-link">
            ...
            <li class="nav-item"> <!-- Logout -->   
                <a href="//localhost/itisdev/logout.php" class="nav-link">
...
<nav class="navbar">
        <ul class="navbar-nav">
            <li class="logo"> <!-- Logo -->
                <a href="<?php echo "//localhost/itisdev/Owner/ownerhome.php"; ?>" class="nav-link">
                    <span class="link-text">Restoranto</span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        <path d="M61.1 224C45 224 32 211 32 194.9c0-1.9 .2-3.7 .6-5.6C37.9 168.3 78.8 32 256 32s218.1 136.3 223.4 157.3c.5 1.9 .6 3.7 .6 5.6c0 16.1-13 29.1-29.1 29.1H61.1zM144 128a16 16 0 1 0 -32 0 16 16 0 1 0 32 0zm240 16a16 16 0 1 0 0-32 16 16 0 1 0 0 32zM272 96a16 16 0 1 0 -32 0 16 16 0 1 0 32 0zM16 304c0-26.5 21.5-48 48-48H448c26.5 0 48 21.5 48 48s-21.5 48-48 48H64c-26.5 0-48-21.5-48-48zm16 96c0-8.8 7.2-16 16-16H464c8.8 0 16 7.2 16 16v16c0 35.3-28.7 64-64 64H96c-35.3 0-64-28.7-64-64V400z"/>
                    </svg>
                </a>
            ...
            <li class="nav-item">
                <a href="//localhost/itisdev/Owner/role_management.php" class="nav-link">
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="nav-item">
                <a href="//localhost/itisdev/Owner/generatereports.php" class="nav-link">
            ...
            <li class="nav-item">
                <a href="//localhost/itisdev/Owner/approvedish.php" class="nav-link">
                <svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" fill="#000000">
                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                <g id="SVGRepo_iconCarrier">
                <path fill="#000000" d="M480 257.152V192h-96a32 32 0 0 1 0-64h256a32 32 0 1 1 0 64h-96v65.152A448 448 0 0 1 955.52 768H68.48A448 448 0 0 1 480 257.152zM128 704h768a384 384 0 1 0-768 0zM96 832h832a32 32 0 1 1 0 64H96a32 32 0 1 1 0-64z">    
                </path>
                </g>
                </svg>  
